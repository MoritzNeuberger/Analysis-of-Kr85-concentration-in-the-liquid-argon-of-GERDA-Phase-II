...
However they are not used in \gerda s analysis.
\\
...
These dimer pairs are meta stable and recombine into two stable argon atoms by the release of a vacuum ultraviolet photon (VUV).
