...
For future experiments with LAr it is now of particular interest to find out why the specific \Kr\ activity in \gerda\ is so much smaller than in the WARP experiment with the same source for its argon but also why it is even smaller than the UAr of Darkside that was supposed to be the more radio pure material.
But it is hard to come up with a reason why it is the case.
The LAr used in \gerda\ was bought commercially and has not been further distilled.
Also the \Kr\ in the atmosphere should have been relatively homogeneous or at least in the same order of magnitude \.
