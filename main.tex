...
\begin{enumerate}
	...
	However, its also unstable daughter nuclei \nuc{K}{42} has the property to have a higher density around the detectors due to its positive charge after being created and the high electrostatic fields in the detectors.
	This creates an effective specific activity of \nuc{Ar}{42} far bigger than expected that could then also cause a notable change in the count rate.
	\end{enumerate}
...
As explained above for the determination of the count rate diagram only those events are considered that lie in the interval of the energy limits. 
...
When plotting all measured test pulse events in a diagram similar to \ref{fig:ZeitLimits} multiplying each bar by 20 s but also dividing them by 
