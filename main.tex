...
The multi-tier structure used in GELATIO can be seen in figure \ref.
...
Additional information about the analysis process can be found in \cite{agostini_gelatio:_2011}.
...
Only recently there was a new unblinding of the measured events at GERDA \PII\ so far.
Unblinding because over all of \PII\ every event with an energy in an interval of $\pm$25keV
