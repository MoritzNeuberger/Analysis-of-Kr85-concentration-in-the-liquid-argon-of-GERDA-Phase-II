...
Still, \Kr's concentration in the atmosphere should everywhere be in the same order of magnitude.
This means that no matter where atmospheric air for an argon extraction would be taken, the concentration of \Kr and therefor its specific activity per liter LAr would be of the same order. 
\\
