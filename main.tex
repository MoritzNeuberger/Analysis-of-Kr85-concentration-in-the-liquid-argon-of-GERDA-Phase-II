...
Candidates for these isotopes are \nuc{Po}{210} ($T_{\frac{1}{2}} = 138 \unit{d}$) and \nuc{Ar}{42} ($T_{\frac{1}{2}} = 32.9 \unit{yr}$).
\nuc{Po}{210} can easily suppressed by setting an upper energy limit of 400 keV on the considered events.
It can be expected that most of its emitted particles have an energy much higher than 400 keV whereas \Kr\ emits most its particles with less energy.
\nuc{Ar}{42} was only expected to have a specific activity of $0.148\mathrm{mBq/l}$.
However, its also unstable daughter nuclei \nuc{K}{42} has the property to have a higher density around the detectors due to it being positive charge right after its creation and its resulting attraction towards the detectors because of their strong electrostatic fields.
This creates an effective specific activity of \nuc{Ar}{42} far bigger than expected which could then also cause a notable change in the count rate.
