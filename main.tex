...
In equilibrium an activity of 0.09PBq in the whole atmosphere originates from these cosmogenic isotopes \cite{winger_new_2005}.
...
But the majority is man made from nuclear power plants.
Krypton is a noble gas and therefore easily diffuses through everything in its way until it reaches the atmosphere.
Due to the higher amount of nuclear power plants build in the last half century the activity of \Kr\ in the atmosphere has risen steadily from about 1961 PBq in 1973 \cite{telegadas_atmospheric_1975} to an estimated 5500 PBq in 2009 (see figure \ref{fig:Kr85Aenderung}) \cite{bieringer_trace_2009}.
\\

It is also interesting that the concentration of \Kr in the air at ground level varies depending on the proximity to a nuclear power plant \cite{weiss_mesoscale_1986}.
If you look at atmospheric altitudes, however, the \Kr concentrations only varies on large length scales since \Kr rises quickly from the ground into the atmosphere, where most of it stays longer.
Different models predict that air from the northern troposphere takes up to one year to get to the southern troposphere delaying the equalization of their \Kr concentrations \cite{}.
