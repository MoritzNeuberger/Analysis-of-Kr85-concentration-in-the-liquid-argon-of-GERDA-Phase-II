...
The \Kr\ in it must also be present there.
When investigating on how  \Kr\ got there, two different sources on earth can be identified.
...
When air is now taken from these heights and separated, in the resulting argon a small concentration of \Kr\ will be left.   
\\
\iffalse
