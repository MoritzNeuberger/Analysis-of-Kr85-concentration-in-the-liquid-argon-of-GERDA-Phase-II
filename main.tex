...
The two different types of argon isotopes have both their majority of electrons emitted at the same energy interval as \Kr.
...
One problem, however, is \nuc{Po}{210}, because it has a half-life much shorter than \Kr's.
But luckily its mean energy of the escaping alpha particle ($\mathcal{O}(5000\unit{keV})$) is much higher than the mean beta energy of \Kr\ (\mathcal{O}(250\unit{keV})).
...
By setting the limit so low it also suppresses the constant background of events with a higher energy that would otherwise making the change in rate less apparent.
\\

All other radioactive isotopes in the \gerda\ \PII\ setup have either a much longer half life than \nuc{Ar}{42}, most of their released particles have an energy over 400keV or their specific activity is too small too small to measure any kind of change over time.
...
This is also the reason for why the data of run 53 and 54 have been neglected from this analysis.
In these two runs the majority of  detectors was turned of resulting in only a small amount of detectors to chose from.
By discarding the data of run 53 and 54 more detectors can be used in the analysis and therefore data.
Which detectors were actually used in this analysis can be seen in graphic ... in the appendix.
\\
