...
Zweitgutachter: Prof.\ P.~Fierlinger \\
Betreuer: Dr.\ J.~Janicskó}
%-------------------------------------------------------------------------------
...
From here on out however it will be assumed that the \onbb\ decay is caused by an exchange of massive Majorana neutrinos as seen in \ref{fig:Feyn0nbb}.
...
The flavor mixing ability of neutrinos as shown by neutrino oscillaion requires their flavor eigenstates that couple to the W boson to be a  superposition of so called mass eigenstates.
\begin{equation}
...
\begin{figure}[t!]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[height=60mm]{./Bilder/NeutrinoMassOrdering.png}
		\caption{}
		\label{fig:MassOrder}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[height=60mm]{./Bilder/TheoretischesSpektrmdes0nubbDecay.png}
