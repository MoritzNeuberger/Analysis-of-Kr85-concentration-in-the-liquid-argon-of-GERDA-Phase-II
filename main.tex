...
\end{equation*}
These mean measuring times represent the time all detectors have to have been measuring to result in the same amount of combined exposure with the individual measuring times.
...
However, this would have been too complicated and the error that results from the simplification can be neglected, since the measuring times of the individual detectors are almost always of the same size.
\\
...
\begin{equation*}
    \bar{a}_{\mathrm{BEGe}} = (0.546\pm0.0827)	\frac{\unit{mBq}}{\unit{l}}
\end{equation*}
and
\begin{equation*}
    \bar{a}_{\mathrm{COAX}} = (0.470\pm0.0887)	\frac{\unit{mBq}}{\unit{l}}
\end{equation*}
These two values differ only inside their range of uncertainty.
Of these two value a mean specific \Kr\ activity of
\begin{equation*}
