...
Because the second method is based on a very broad approximation it is expected to only give one a rough estimation of the actual concentration. In contrast, the first method is expected to wield a much better appraisal because 
