...
For this method to be applied it is necessary to expect that in the time interval of all of \PII only the intensity of the \Kr isotope has a non neglectable change in its intensity.
...
On the other hand, the two different types of argon isotopes also have both a mean beta energy close to \Kr's 251.59 keV for the most likely decay.
...
All other radioactive isotopes that are risidual in the liquid argon have either a much longer half life than \nuc{Ar}{42}, their mean beta energy is much higher than 400keV or their specific activity is too small to measure any kind of change over time.
...
This results in an mean specific activity of $ \bar{a_{2}} = 0.057294 \frac{\unit{Bq}}{\unit{l}}$.
\\
...
Compared to \nuc{Ar}{39} which also has its mean beta energy in the same energy range as \Kr this still holds true with its half life of 269 y.
In all of Phase II its specific activity should have only dropped by 0.56$ \% $ which can be ignored.
\\

As already indicated in the beginning of this chapter we now have to discuss the influence of \nuc{Ar}{42}.
\nuc{Ar}{42} has a half life of 32.9 y.
Over all phase II it should therefore show a decrease of about 4.4$\%$ which should actually be possible to detect.
But due to its low specific activity this would result in a decrease of $7 \frac{\unit{\mu Bq}}{\unit{l}}$.
This by far not enough to explain the much greater decrease as seen in \ref{fig:activity}.
\\

But what is really interesting about \nuc{Ar}{42}, is not the decay of \nuc{Ar}{42} itself, but rather  the decay of the daughter nuclei \nuc{K}{42}.
\nuc{K}{42} has a half life of 12.355 h \cite{chen_nuclear_2016}.
Due to this half life being much lower than \nuc{Ar}{42}'s it can be approximated that \nuc{K}{42}'s specific activity is equal to \nuc{Ar}{42}s specific activity.
This can be assumed, because in comparison to the half life of \nuc{Ar}{42} the resulting \nuc{K}{42} practically instantaneously decays further.
This means that for every \nuc{Ar}{42} we can measure two individual decays resulting in a doubling of the initial \nuc{Ar}{42} activity.
But even with \nuc{Ar}{42}'s decay rate effectively doubled the resulting specific activity is still to small to explain the comparably drastic change over time.  
\\

The critical point is that \nuc{K}{42}s specific activity around the detector is not equal to the specific activity of \nuc{Ar}{42} as assumed in the paragraph above.
Based on the considerations just made, we concluded that \nuc{Ar}{42} and \nuc{K}{42} must have the same amount of decays in the liquid argon tank.
But without mentioning it, we assumed that the distribution of \nuc{K}{42} in the liquid argon remains homogeneously distributed after its formation. 
What we didn't consider was the fact that after the beta decay of \nuc{Ar}{42} the forming \nuc{K}{42} nuclei it is positively ionized.
Because of this positive charge, the \nuc{K}{42} are being attracted towards the germanium detectors due to their electric field.
These ionized \nuc{K}{42} in the liquid argon also have a relatively long characteristic time in which they stay ionized resulting in a relatively long traveling time.
After they catch an additional electron to compensate the positive charge the \nuc{K}{42} nuclei will stop moving and stay in their position.
This means that we can expect a higher \nuc{K}{42} density around the detectors than on the wall of the liquid argon tank, which leads to an inhomogeneous distribution.
Because of the higher density of \nuc{K}{42} around the detectors the specific activity in this area must also be higher than far away from the detectors.
As a result, a much higher specific activity of \nuc{K}{42} and \nuc{Ar}{42} can also be measured in the detectors in contrast to the case in which we assumed a homogeneous distribution.
\\

Whether this higher specific activity of \nuc{K}{42} in the area of the detectors is enough to explain the greater amplitude in the measured diagram can 


!!!!! hier brauche ich noch das paper zur charakteritsichen Zeit in der das Nuklid ionisiert ist !!!!!
