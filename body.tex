...
As a graphical representation you can see the peaks that one would have been able to be seen in the measured spectrum if an specific activity of the WARP or the Darkside experiment was present in figure \ref{fig:WARP} and \ref{fig:Darkside}.
...
\begin{figure}[t!]
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[height=80mm]{./Bilder/WARP.pdf}
		\caption{Cross section from above}
		\label{fig:WARP}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[height=80mm]{./Bilder/Darkside.png}
		\caption{Radial cross section}
		\label{fig:Darkside}
	\end{subfigure}
    \\
...
If one would measure its equivalent amplitude in a diagram like Figure \ref{fig:ChangeInEventRateFit}, it would strongly dominate the constant background and a significant change would have been visible.
