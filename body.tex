...
Therefore, we do expect the ratio of the detector efficiency and the volume to be constant when one uses a larger liquid argon tank.
This is the reason why we were able to use a smaller volume of liquid argon in the MCS than was actually used in the experiment.
\\
...
\begin{equation}
    \epsilon_{\gamma} = \frac{\Delta\mathrm{N}}{\mathrm{N}}
    \label{equ:DetEff514}
\end{equation}
\\
