...
The two examples will be used in this thesis are the WARP and the Darkside experiment.
Both of these experiments have set their aim to detect WIMPs (Weakly Interacting Massive Particles) which are candidates for dark matter.
These WIMPs should in the case of their existence theoretically create tiny recoils produced in ordinary matter by the elastic scattering.
...
Due to the small expected interaction cross section of the WIMPs all background sources have to be well known and in both of these experiments a value for the specific activity of the residual \Kr has been determined.
...
It is now of interest to determine the specific activity for the GERDA experiment to know how much of an impact it has on the radioactive background.
...
!!!! hier kann man noch einen Paragraphen zu einer qualitativen Abschätzung einfügen !!!!!
