...
After it was explaining what a beta decay is and how per beta decay one neutrino is emitted the double beta decay will be explained.
...
Double beta decays have already been observed and a great amount materials have been found to decay via this transition.
The found half life of such decays have been found to be in the order of $10^{19}$ to $10^{21} \units{ys}$ and therefor needed a lot of background to identify it over the background.
\\
...
This special kind of transition is call the neutrinoless double beta decay and has not yet been observed.
However it was to be found it would have profound consequences because most notably this transition does not conserve the lepton number conservation due to two electrons being created solemnly as seen in the most likely leading channel
\begin{equation}
...
There are also other interpretations on how the neutrinoless double beta decay might work but the concept of light Majorana neutrino interaction requires only a minimal extension to the standard model compared to the other theories.
The only extensions necessary are the assumption of the Majorana nature of the neutrinos and their non zero mass.
...
!!!!! Hier ist noch ein kleines Problem in der Erklärung warum wir so wenig licht erwarten !!!!!
...
With the scintillation yield of $10^4 \frac{\unit{photons}}{\unit{MeV}}$ an amount of about 476 photons should be expected to be created.
of liquid argon of about 50 photons/MeV one can expect about 2.5 photons at these energies. 
...
!!!!! DAS HIER IST AUCH NOCH EINE PROBLEMSTELLE !!!!! Problem hier ist, dass der Mechanismus ander funktioniert, kein relaxations Verhalten, tatsächlich praktisch instantane emission !!!!!
