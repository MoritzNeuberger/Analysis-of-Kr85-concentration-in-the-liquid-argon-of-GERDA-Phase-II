...
Not finally with the values of the amplitude, the conversion factor and the mean measuring time a mean specific activity can be determined. 
...
Now that we have the two spectra of the corresponding detectors, we have two possible ways of how we could determine the number of measured events around the 514keV peak.
...
Another possible approach is to try to suppress the annihilation peak and then fit the spectrum with only one Gaussian peak.
