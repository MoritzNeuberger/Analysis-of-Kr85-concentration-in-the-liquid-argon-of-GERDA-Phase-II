...
Another method uses reducing the rate in a range from 200 to 500 keV. This is possible because every other isotope we know that has a non negligible fraction in liquid argon has half-life much higher than \nuc{Kr}{85} of \(10.739\mathrm{y}\). The dominant background sources are in descending order Ar42 with a half-life of 32.9 y, Ar39 with 269 y and U 232 with 68.9 y. Since the liquid argon has not been replaced since the beginning of GERDA Phase 1 in 2013, it can be estimated that the Kr85 rate has decreased by about square root of two while the rate of the other isotopes should have hardly changed.
