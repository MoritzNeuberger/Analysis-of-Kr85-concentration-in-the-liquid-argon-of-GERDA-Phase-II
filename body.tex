...
As mentioned in section \ref{sec:Kry85} the probability of the rare decay is $p_{\mathrm{rare}} = 0.00434$.
We can therefor calculate a deca density of 
\begin{equation*}
\mathrm{N}_{BEGe}\times\frac{1}{\epsilon_\gamma V_{sim}} =  3737.892\frac{\mathrm{decays(all)}}{\mathrm{l}} 
\end{equation*}
\\
