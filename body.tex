...
It was determined that all events with either more than 3phe of light intensity, more than two events in one photomultiplier in the time window of interest (5\(\mu\)s - 0\(\mu\)s) or more than 2keV of energy difference from the 514keV peak are filtered out.
