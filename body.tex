...
But its specific activity has already been determined to be about $148\muiBq/l$ \cite{becerici_schmidt_results_2014} which is about factor 3.5 smaller than the expected \Kr specific activity.
...
Now finally \nuc{Ar}{42} comes into play.
As we already mentioned in the beginning of this chapter, \nuc{Ar}{42} has a half life of 32.9 y.
Over the time of \PII it should show a drop in activity of 4.4$\%$ which results in a decrease of $7 \frac{\unit{\muBq}}{\unit{l}}$.
This by far not enough to explain the much greater decrease of specific activity measured.
But what is really interesting about this decay is not the decay of \nuc{Ar}{42} but rather the decay of the resulting daughter nuclei \nuc{K}{42}.
\nuc{K}{42} has a half life of 12.355 h \cite{chen_nuclear_2016} but due to it being a daugther nuclei of a isotope with a much higher half life its effective specific activity should be equal to the one of \nuc{Ar}{42}.
\\
