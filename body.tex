...
Most notably the values C and F, being the variances of two Gaussian peaks, were each left free only on a very small range around the values derived from the resolutions of the detectors at the specific energies ().
