...
The simulation used here consists of a cylindrical volume of about 17m\(^{3}\), in which the detector structure of the GERDA experiment is placed in the middle. 
A total of 50 million rare \nuc{Kr}{85} decays in the volume of this cylinder not occupied by the detector are now simulated. 
As can be seen in figure \ref{fig:CrossSecAb}, the density of the decays over the entire volume of the cylinder is almost constant.
...
The resulting phase-space diagram form all the detected events in any of the BEGes is shown in figure 
\\
