...
It should then be possible to determine A mean activity from \nuc{Kr}{85} over the course of Phase II.
\\
...
This is because in this approach only \nuc{Kr}{85} decays actually generate the change in the phase diagram while in the second method many other isotopes can produce additional changes.
...
Nevertheless we were able to lower the number of potential rare \nuc{Kr}{85} events from 1728 down to only 55.  
...
After this much filtering we can assume that probably all of these events are real rare \nuc{Kr}{85} decays.
...
Our strategy to calculate the activity of \nuc{Kr}{85} through the 514keV peak involves determining the absolute amount of measured rare \nuc{Kr}{85} decays over all of Phase II.
