...
This can easily be done by integrating the exponential function with fit parameter A and B over all of \PII and then dividing it by 2.17 years.
\begin{equation*}
    \bar{a} = \int_0^{2.17y} \mathrm{A}\times\exp \left( \frac{\log(2)}{\mathrm{B}} t \right) \mathrm{d}t
\end{equation*}
